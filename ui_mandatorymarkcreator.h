...
public:
    ...
    void setupUi(QDialog *MandatoryMarkCreator)
    {
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::LabelRole, name_label);

        accesslevel_label = new QLabel(MandatoryMarkCreator);
        accesslevel_label->setObjectName("accesslevel_label");

        formLayout->setWidget(1, QFormLayout::ItemRole::LabelRole, accesslevel_label);

        MarkName_lineEdit = new QLineEdit(MandatoryMarkCreator);
        MarkName_lineEdit->setObjectName("MarkName_lineEdit");

        formLayout->setWidget(0, QFormLayout::ItemRole::FieldRole, MarkName_lineEdit);
        ...
        formLayout->setWidget(1, QFormLayout::ItemRole::FieldRole, accesslevel_Slider);

        Currentposition_label = new QLabel(MandatoryMarkCreator);
        Currentposition_label->setObjectName("Currentposition_label");

        formLayout->setWidget(2, QFormLayout::ItemRole::FieldRole, Currentposition_label);
