...
public:
    ...
    void setupUi(QDialog *AddDevice)
    {
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::LabelRole, DeviceType_Label);

        SelectDevice_Label = new QLabel(AddDevice);
        SelectDevice_Label->setObjectName("SelectDevice_Label");

        formLayout->setWidget(1, QFormLayout::ItemRole::LabelRole, SelectDevice_Label);

        SelectDevice_Layout = new QVBoxLayout();
        SelectDevice_Layout->setObjectName("SelectDevice_Layout");

        formLayout->setLayout(1, QFormLayout::ItemRole::FieldRole, SelectDevice_Layout);

        Resolution_Label = new QLabel(AddDevice);
        Resolution_Label->setObjectName("Resolution_Label");

        formLayout->setWidget(2, QFormLayout::ItemRole::LabelRole, Resolution_Label);
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::FieldRole, DevType_ComboBox);

        Resolution_ComboBox = new QComboBox(AddDevice);
        Resolution_ComboBox->setObjectName("Resolution_ComboBox");

        formLayout->setWidget(2, QFormLayout::ItemRole::FieldRole, Resolution_ComboBox);
        ...
        formLayout->setWidget(4, QFormLayout::ItemRole::FieldRole, Transform_ComboBox);

        Transform_Label = new QLabel(AddDevice);
        Transform_Label->setObjectName("Transform_Label");

        formLayout->setWidget(4, QFormLayout::ItemRole::LabelRole, Transform_Label);

        Caption_Edit = new QLineEdit(AddDevice);
        Caption_Edit->setObjectName("Caption_Edit");

        formLayout->setWidget(3, QFormLayout::ItemRole::FieldRole, Caption_Edit);

        Caption_Label = new QLabel(AddDevice);
        Caption_Label->setObjectName("Caption_Label");

        formLayout->setWidget(3, QFormLayout::ItemRole::LabelRole, Caption_Label);
