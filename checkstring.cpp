...
CheckString::CheckString(QObject *parent) : QObject(parent)
{

}
bool CheckString::CheckPassword(QString Password, QString PasswordRpt)
{   bool ok=false;
...
bool CheckString::CheckUserExist(QString username)
{
